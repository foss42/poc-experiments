...
// //   async connect(wsUrl: string): Promise<MCPTool[]> {
// //     try {
...
// //     this.tools = []
// //     this.transport = null
// //     // Create fresh client instance for next connect
// //     this.mcp = new Client({ 
// //       name: "mcp-dev-poc", 
// //       version: "1.0.0" 
// //     })
...
// // export type { MCPTool, ToolCallResult }
...
//   async connect(command: string): Promise<MCPTool[]> {
//     try {
//       // Pass command as URL param
//       // Proxy reads this and spawns server immediately
//       this.transport = new WebSocketClientTransport(
//         new URL(
//           `ws://localhost:3333?command=${encodeURIComponent(command)}`
//         )
//       )
//       await this.mcp.connect(this.transport)
