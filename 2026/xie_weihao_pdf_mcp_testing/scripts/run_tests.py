...
from scenarios import run_pdf_workflow_scenarios

TEST_SPECS: list[tuple[str, str, str]] = [
    ("Tool contracts", "tests.test_tool_contracts", "run_test"),
    ("Text workflow", "tests.test_text_workflow", "run_test"),
    ("Structure features", "tests.test_structure_features", "run_test"),
    ("Image payloads", "tests.test_image_payloads", "run_test"),
...
def main() -> int:
    print("Running PDF Reader MCP Testing PoC...\n")
    failures: list[str] = []
    ...
    for scenario in run_pdf_workflow_scenarios():
