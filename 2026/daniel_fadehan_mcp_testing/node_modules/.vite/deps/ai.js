...
import {
  ...
  zodSchema
} from "./chunk-X7RB7PGG.js";
import {
  external_exports
} from "./chunk-422OGIUC.js";
import {
  __commonJS,
  __toESM
...
var require_get_context = __commonJS({
  "node_modules/@vercel/oidc/dist/get-context.js"(exports, module) {
    ...
    function getContext3() {
      ...
      return ((_b9 = (_a21 = fromSymbol[SYMBOL_FOR_REQ_CONTEXT]) == null ? void 0 : _a21.get) == null ? void 0 : _b9.call(_a21)) ?? {};
    }
  }
});
  ...
  function() {
    ...
    BaggageImpl2.prototype.getAllEntries = function() {
      return Array.from(this._entries.entries()).map(function(_a21) {
        var _b9 = __read3(_a21, 2), k = _b9[0], v = _b9[1];
        return [k, v];
      });
    };
...
var MetricsAPI = (
  ...
  function() {
    ...
    MetricsAPI2.prototype.getMeter = function(name21, version, options) {
      return this.getMeterProvider().getMeter(name21, version, options);
    };
...
var marker92 = `vercel.ai.error.${name9}`;
...
function resolveTranscriptionModel(model) {
  ...
  return (_b9 = (_a21 = getGlobalProvider()).transcriptionModel) == null ? void 0 : _b9.call(_a21, model);
}
function resolveSpeechModel(model) {
  ...
  return (_b9 = (_a21 = getGlobalProvider()).speechModel) == null ? void 0 : _b9.call(_a21, model);
}
...
var VERSION3 = true ? "6.0.142" : "0.0.0-test";
var download = async ({
  url,
  maxBytes,
  abortSignal
...
function bindTelemetryIntegration(integration) {
  var _a21, _b9, _c, _d, _e, _f;
  return {
    onStart: (_a21 = integration.onStart) == null ? void 0 : _a21.bind(integration),
    onStepStart: (_b9 = integration.onStepStart) == null ? void 0 : _b9.bind(integration),
...
function hasToolCall(toolName) {
  return ({ steps }) => {
    var _a21, _b9, _c;
    return (_c = (_b9 = (_a21 = steps[steps.length - 1]) == null ? void 0 : _a21.toolCalls) == null ? void 0 : _b9.some(
            ...
            await selectTelemetryAttributes({
              ...
              attributes: {
                ...
                "ai.response.toolCalls": {
                  output: () => {
                    var _a222;
                    return ((_a222 = finalStep.toolCalls) == null ? void 0 : _a222.length) ? JSON.stringify(finalStep.toolCalls) : void 0;
                  }
                },
                "ai.response.providerMetadata": JSON.stringify(
            ...
            self2.addStream(
              streamWithToolResults.pipeThrough(
                new TransformStream({
                  ...
                  async flush(controller) {
                    var _a222, _b22, _c2, _d2, _e2, _f2, _g2;
                      ...
                      doStreamSpan.setAttributes(
                        await selectTelemetryAttributes({
                          ...
                          attributes: {
                            ...
                            "ai.usage.inputTokenDetails.noCacheTokens": (_a222 = stepUsage.inputTokenDetails) == null ? void 0 : _a222.noCacheTokens,
...
var ToolLoopAgent = class {
  ...
  async prepareCall(options) {
    ...
    const preparedCallArgs = (_d = await ((_c = (_b9 = this.settings).prepareCall) == null ? void 0 : _c.call(
      _b9,
      baseCallArgs
    ...
    if (result.providerMetadata) {
      for (const [providerName, metadata] of Object.entries(result.providerMetadata)) {
        if (providerName === "gateway") {
          ...
          (_b9 = providerMetadata[providerName]) != null ? _b9 : providerMetadata[providerName] = { images: [] };
      ...
      fn: async (span) => {
        ...
        const generateResult = await retry(
          () => recordSpan({
            ...
            tracer,
            fn: async (span2) => {
              var _a222, _b9, _c, _d, _e, _f, _g, _h;
              ...
              const responseData = {
                id: (_b9 = (_a222 = result2.response) == null ? void 0 : _a222.id) != null ? _b9 : generateId2(),
              ...
              switch (chunk.type) {
                case "response-metadata": {
                  fullResponse = {
                    ...
                    timestamp: (_b9 = chunk.timestamp) != null ? _b9 : fullResponse.timestamp,
...
function normalizePrompt2(promptArg) {
  ...
  if (promptArg.image != null) {
    ...
    if (typeof dataContent === "string") {
      ...
      const mediaType = (_b9 = detectMediaType({
        data: dataContent,
        signatures: imageMediaTypeSignatures
      })) != null ? _b9 : "image/png";
      image = {
...
var doWrap3 = ({
  ...
  return {
    specificationVersion: "v3",
    provider: (_b9 = providerId != null ? providerId : overrideProvider == null ? void 0 : overrideProvider({ model })) != null ? _b9 : model.provider,
...
var DefaultProviderRegistry = class {
  ...
  languageModel(id) {
    ...
    let model = (_b9 = (_a21 = this.getProvider(providerId, "languageModel")).languageModel) == null ? void 0 : _b9.call(
      _a21,
      modelId
    );
    if (model == null) {
    ...
    fn: async () => {
      ...
      return new DefaultRerankResult({
        ...
        response: {
          ...
          modelId: (_b9 = response == null ? void 0 : response.modelId) != null ? _b9 : model.modelId,
          headers: response == null ? void 0 : response.headers,
