...
export const JsonRpcLogEntrySchema = z.object({
  id: z.string(),
  timestamp: z.string(),
  direction: z.enum(['host-to-iframe', 'iframe-to-host']),
  method: z.string().optional(),
  jsonrpcId: z.union([z.string(), z.number()]).optional(),
  payload: z.unknown(),
  isValid: z.boolean(),
  validationError: z.string().optional(),
});
export type JsonRpcLogEntry = z.infer<typeof JsonRpcLogEntrySchema>;

export const AppApiCheckSchema = z.object({
  name: z.string(),
  status: z.enum(['pass', 'fail', 'pending', 'not-applicable']),
  description: z.string(),
});
export type AppApiCheck = z.infer<typeof AppApiCheckSchema>;
